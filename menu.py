...
def spam_comment_post_grup():
    ...
    print(colored("Pastikan akun sudah bergabung dengan grup target!", "light_red").center(62))
    ...
    print(colored("Gunakan -- untuk baris baru!", "light_red").center(62))
    ...
    try:
        ...
        link_grup = f"https://web.facebook.com/groups/{id_grup}"

    except Exception as e:
        print(colored(f"Error: {e}", "red"))

def spam_comment_post_feed():
    pass

def auto_comment_post():
    pass

def fast_comment_new_post_grup():
